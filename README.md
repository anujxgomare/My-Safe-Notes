...
2. 🎫 On successful authentication, a JWT token is issued  
3. 🔐 The token is used to access secured REST APIs  
4. 📲 If MFA is enabled, an additional OTP verification step is required  
